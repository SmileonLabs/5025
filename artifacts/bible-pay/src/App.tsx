...
import ParentReadingResultsPage from "@/pages/parent/ReadingResultsPage";
...
import GreatQuestionNotebookPage from "@/pages/child/GreatQuestionNotebookPage";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/parent/reading-results" component={ParentReadingResultsPage} />
      ...
      <Route path="/child/great-question/notebook" component={GreatQuestionNotebookPage} />
